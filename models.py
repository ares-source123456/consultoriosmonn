...
class Movimiento(db.Model):
    ...
    # Si es ingreso, puede estar vinculado a un pago de consulta
    pago_id = db.Column(db.Integer, db.ForeignKey('pagos.id'))
    
    # 🆕 NUEVO: Si es ingreso, puede estar vinculado a un pago mensual de prepaga
    pago_prepaga_id = db.Column(db.Integer, db.ForeignKey('pagos_mensuales_prepaga.id'))
